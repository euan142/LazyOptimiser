...
Ever get annoyed you have to go back and re-optimise an avatar because you want to add / adjust something? Want to push what you avatar can do but don't want to put a ton of effort into optimising? Well you too can be lazy (somewhat) in your avatar creation but still be (somewhat) optimised using these automated tools![^1]
...
**Merge meshes** (still in development)  
...
- [VRCSDK3A](https://vrchat.com/home/download)
- DynamicBone (looking to remove this dependency, if you don't have it uncomment the first line of Source/Editor/RemoveUnusedGameObjects.cs)
